...
@section('title')
Enroll Courses for {{ $user->username }}
@endsection
...
<section class="section">
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">Enroll Courses for {{ $user->username }}</h5>

            <!-- General Form Elements -->
            <form action="{{ route('students-enrollments.store', $user->id) }}" method="POST">
                @csrf
